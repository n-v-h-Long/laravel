					...
					<div id="slider-carousel" class="carousel slide" data-ride="carousel">
						...
						<div class="carousel-inner">
							...
							<div class="item {{$i ==1 ? 'active' : ''}}">
								...
								<div class="col-sm-12">
									<img src="public/uploads/slider/{{$slide->slider_image}}" height="100px" width="100%" class="img img-responsive">
            ...
            $('.send_order').click(function(){
                ...
                function(isConfirm){
                    ...
                    $.ajax({
                        ...
                        shipping_notes:shipping_notes,_token:_token,order_fee:order_fee,
                        order_coupon:order_coupon,shipping_method:shipping_method},
