                ...
                <div class="col-sm-12 clearfix">
                    <div class="bill-to">
                        ...
                        <div class="form-one">
                                ...
                                <div class="">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control input-sm m-bot15 payment_select" name="payment_select" >
                                            <option value="0">Qua chuyển khoảng</option>
                                            <option value="1">Bằng tiền mặt</option>
                                        </select>
                                    </div>
                                </div>
                                <input type="button" value="Xác nhận đơn hàng" name="send_order" class="btn btn-primary bbtn-sm send_order">
                            </form>
                            <form >
                                @csrf
                            ...
                            <input type="button" value="Tính phí vận chuyển" name="calculate_order" class="btn btn-primary bbtn-sm calculate_delivery">
                        </form>
                        ...
                        <form action="{{url('/update-cart')}}" method="POST">
                            ...
                            <table class="table table-condensed">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <input type="submit" value="Cập nhật giỏ hàng" name="update_qty" class="check_out btn btn-default bbtn-sm">
                                        </td>
                                        <td>
                                            <a class="btn btn-default check_out" href="{{url('/del-all-product')}}">Xoá tất cả</a>
                                        </td>
                                        <td>
                                            @if (Session::get('coupon'))
